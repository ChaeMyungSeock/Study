...
model = XGBClassifier(objective='multi:softmax',n_estimators=1000, learning_rate=0.1)

# model.fit(x_train, y_train, verbose=True,  eval_metric= "error",
#                 eval_set=[(x_train, y_train), (x_test, y_test)])
model.fit(x_train, y_train, eval_metric= "merror",eval_set=[(x_train, y_train), (x_test, y_test)])
...
'''
Thresh=0.012, n=4, R2: 91.75%
R2는 0.9173104398796882
Thresh=0.023, n=3, R2: 91.73%
R2는 0.9340205647421339
Thresh=0.362, n=2, R2: 93.40%
R2는 0.9444573526491337
Thresh=0.603, n=1, R2: 94.45%
'''