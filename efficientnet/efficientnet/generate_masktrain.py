...
train_generator = train_datagen.flow_from_directory(
    '/home/john/Study/pytorch_retinaface/facedetect/data/train',
    target_size=(224,224),
    shuffle=True,
    seed=66,
    batch_size=64,
    # batch_size =2, val_acc => 0.75
    class_mode = 'binary'
)
# train_generator2 = train_datagen.flow_from_directory(
#     '/home/john/Study/pytorch_retinaface/facedetect/data/train/without_mask',
#     target_size=(224,224),
#     batch_size=64,
#     shuffle = True,
#     # batch_size =2, val_acc => 0.75
...
model.compile(optimizer = 'adam', loss = tf.keras.losses.BinaryCrossentropy(label_smoothing=0.9), metrics = ['acc'])
...
model.save('/home/john/Study/mask/weight/nonweight_mask_model_1007.h5')
