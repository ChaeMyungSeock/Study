...
dense4 = Dense(256,activation='relu')(dense4)
...
hist = model.fit(x_train, y_train, batch_size=100, epochs=10, verbose=1, callbacks=[earlystopping, modelcheckpoint], validation_split=0.15,)
