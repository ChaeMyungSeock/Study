...
x1_train, x1_test, y1_train, y1_test,x2_train, x2_test  = train_test_split(x1,y1,x2 ,shuffle = False,  train_size = 0.8 )
...
dense1 = Dense(12, activation='relu', name ='start2' )(input1)
dense1 = Dense(12, activation='relu',name ='start3')(dense1)
output1 = Dense(50)(dense1)

input2 = Input(shape = (3,)) #열우선
dense2 = Dense(12, activation='relu')(input1)
dense2 = Dense(12, activation='relu')(dense2)
output2 = Dense(50)(dense2)
...
earlystopping = EarlyStopping(monitor = 'loss',patience =4,mode='min')
