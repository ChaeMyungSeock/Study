...
x1_train, x1_test, y1_train, y1_test,x2_train, x2_test  = train_test_split(x1,y1,x2 ,shuffle = True, random_state =66,  train_size = 0.8 )
...
dense1 = Dense(100, activation='relu', name ='start2' )(input1)
dense1 = Dense(50, activation='relu',name ='start3')(dense1)
output1 = Dense(1000)(dense1)

input2 = Input(shape = (3,)) #열우선
dense2 = Dense(100, activation='relu')(input1)
dense2 = Dense(50, activation='relu')(dense2)
output2 = Dense(1000)(dense2)

merge1 = concatenate([output1, output2])
# merge1 = Concatenate()[output1, output2]

model1 = Dense(1000)(merge1)
model1 = Dense(1000)(model1)

############### output 모델 구성

output3 = Dense(310)(model1)
...
model1.fit([x1_train,x2_train,] , [y1_train],epochs=10, batch_size=1, validation_split=0.25,verbose=1, callbacks=[earlystopping])
