...
x_train, x_test, y_train, y_test = train_test_split(x,y, shuffle = False,  train_size = 0.5 )
# (x,y, random_state = 66, 
...
model.fit(x_train,y_train, epochs=45, batch_size=8, validation_split=0.25,verbose=0)
